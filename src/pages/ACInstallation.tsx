    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 px-6 md:px-20 max-w-5xl mx-auto">
        ...
        <p className="text-gray-700 mb-6">
          Got an AC emergency? Our contractors are available From monday to friday 9AM to 7PM. We’ll help you choose the best cooling system for your home, comfort needs, and budget. With Proluma, you’ll always receive:
        </p>
